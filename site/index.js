...
(function () {
  const TEXT = {
    en: {
      ...
      feedsTitle: 'Feeds',
      feedsBody: 'Every new video from the channels you follow, in one list, newest first. Named groups narrow it. Live streams and premieres are tagged. Shorts stay hidden unless you want them. A New tag marks what arrived since you last opened the popup.',
    ...
    ar: {
      ...
      feedsTitle: 'الموجز',
      feedsBody: 'كل فيديو جديد من القنوات التي تتابعها في قائمة واحدة، الأحدث أولًا. المجموعات تضيّق القائمة. البث المباشر والعروض الأولى عليها وسم واضح، والفيديوهات القصيرة مخفية إلا إذا أردتها. وسم «جديد» يميّز ما وصل منذ آخر زيارة.',
