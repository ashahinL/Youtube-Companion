...
(function () {
  const TEXT = {
    en: {
      ...
      feedsTitle: 'Feeds',
      feedsBody: 'Every new video from the channels you follow, in one list, newest first. Named groups narrow it, here and as chips on YouTube\'s own Subscriptions page. Live streams and premieres are tagged. Shorts stay hidden unless you want them. A New tag marks what arrived since you last opened the popup.',
      watchlistTitle: 'Watchlist',
      watchlistBody: 'Add a channel by pasting its link or @handle, or press Add on the tab you are on. Import your YouTube subscriptions straight from your signed-in YouTube tab, choosing the Google account if you have several; the list is read on your device. Signed out? A Google Takeout file works too. Star favourites. Mute alerts for one channel from its menu; its videos still show in the feed.',
      playerTitle: 'Player',
      ...
      queueTitle: 'Up next',
      queueBody: 'Add videos from your feed to a listen-later list under the player. Press Play all and it plays itself in one tab, moving on as each video ends, with audio mode on or off and the popup closed.',
    ...
    ar: {
      ...
      feedsTitle: 'الموجز',
      feedsBody: 'كل فيديو جديد من القنوات التي تتابعها في قائمة واحدة، الأحدث أولًا. المجموعات تضيّق القائمة، هنا وكأزرار في صفحة الاشتراكات على يوتيوب نفسه. البث المباشر والعروض الأولى عليها وسم واضح، والفيديوهات القصيرة مخفية إلا إذا أردتها. وسم «جديد» يميّز ما وصل منذ آخر زيارة.',
      watchlistTitle: 'قائمة المتابعة',
      watchlistBody: 'أضف قناة بلصق رابطها أو ‎@handle، أو اضغط «إضافة» وأنت على تبويب القناة. استورد اشتراكاتك مباشرة من تبويب يوتيوب الذي سجّلت فيه الدخول، واختر حساب Google إن كان لديك أكثر من حساب؛ تُقرأ القائمة على جهازك. لست مسجّل الدخول؟ ملف Google Takeout يعمل أيضًا. ميّز المفضلة بنجمة. اكتم تنبيهات قناة من قائمتها؛ وتبقى فيديوهاتها في الموجز.',
      playerTitle: 'مشغّل',
      ...
      queueTitle: 'التالي',
      queueBody: 'أضف فيديوهات من موجزك إلى قائمة «استمع لاحقًا» تحت المشغّل. اضغط «تشغيل الكل» فتعمل وحدها في تبويب واحد، وتنتقل للتالي عند انتهاء كل فيديو، مع وضع الصوت أو بدونه والنافذة مغلقة.',
